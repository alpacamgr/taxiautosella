...
export const AmberCookiePolicyPage: React.FC = () => {
        ...
        <div className="space-y-10">
          <section>
            <p className="text-base leading-relaxed text-tas-ink">
              <Trans
                ...
                components={{
                  privacy: (
                    <Link to="/privacy" className="text-tas-accent-on-light hover:text-tas-accent-strong underline-offset-4 hover:underline" />
                  ),
                }}
              />
            </p>
          ...
          <section>
            ...
            <button
              ...
              className="mt-4 inline-flex min-h-12 items-center justify-center gap-2 rounded-lg bg-tas-primary px-5 text-sm font-bold text-tas-on-accent transition-colors hover:bg-tas-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tas-focus focus-visible:ring-offset-2"
            >
...
export default AmberCookiePolicyPage;
