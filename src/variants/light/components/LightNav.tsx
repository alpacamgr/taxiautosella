...
export const LightNav: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 max-w-[1440px] items-center gap-3 px-4 sm:h-[72px] sm:px-6 xl:px-8">
        <Link
          to="/"
          className="flex min-h-11 flex-none items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tas-primary focus-visible:ring-offset-2"
        ...
        <div className="hidden min-w-0 flex-1 items-center justify-center gap-1 xl:flex">
          {links.map((l) => (
            <NavLink
              ...
              to={l.path}
              className={({ isActive }) =>
                `whitespace-nowrap rounded-lg px-3 py-2 text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tas-primary ${
                  isActive
                    ? 'bg-tas-primary-soft text-tas-primary'
        ...
        <div className="ml-auto flex flex-none items-center gap-2">
          ...
          <a
            ...
            className="hidden min-h-11 items-center gap-2 rounded-lg px-3 text-sm font-semibold text-tas-ink transition-colors hover:text-tas-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tas-primary lg:flex"
          >
          ...
          <button
            ...
            className="flex min-h-11 items-center whitespace-nowrap rounded-lg bg-tas-primary px-3.5 text-sm font-bold text-white transition-colors hover:bg-tas-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tas-primary focus-visible:ring-offset-2 sm:px-5"
          >
          ...
          <button
            ...
            className="flex min-h-11 min-w-11 items-center justify-center rounded-lg text-tas-ink transition-colors hover:bg-tas-parchment focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tas-primary xl:hidden"
            ...
            <div className="flex flex-col">
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex min-h-12 items-center rounded-lg px-3 text-base font-semibold transition-colors ${
                    isActive ? 'bg-tas-primary-soft text-tas-primary' : 'text-tas-ink hover:bg-tas-parchment'
                  }`
                }
              >
                {t('nav.home')}
              ...
              {links.map((l) => (
                <NavLink
                  ...
                  onClick={() => setIsMobileMenuOpen(false)}
                  className={({ isActive }) =>
                    `flex min-h-12 items-center rounded-lg px-3 text-base font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-tas-primary ${
                      isActive ? 'bg-tas-primary-soft text-tas-primary' : 'text-tas-ink hover:bg-tas-parchment'
                    }`
                  }
                >
