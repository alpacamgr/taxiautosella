...
export const LightContactPage: React.FC = () => {
          ...
          <div className="space-y-6">
            <Reveal>
              <div className="rounded-xl border border-tas-line bg-tas-surface p-6 shadow-card sm:p-8">
                ...
                <dl className="mt-6 space-y-5 border-t border-tas-line pt-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <dd className="mt-1">
                        <a
                          href={`tel:${PHONE_TEL}`}
                          className="text-base font-semibold text-tas-primary hover:text-tas-primary-hover"
                        >
                          {PHONE_DISPLAY}
                        </a>
                      </dd>
                  ...
                  <div className="flex items-start gap-3">
                    <span
                      className="flex h-11 w-11 flex-none items-center justify-center rounded-full bg-tas-primary-soft text-sm font-bold text-tas-primary"
                      aria-hidden="true"
                    >
                      {t('address.vatBadge')}
                    </span>
            ...
            <Reveal delay={60}>
              <div className="rounded-xl bg-tas-primary-soft p-6 sm:p-8">
                <div className="flex items-start gap-3">
                  <span className="flex h-11 w-11 flex-none items-center justify-center rounded-full bg-white text-tas-primary">
...
export default LightContactPage;
