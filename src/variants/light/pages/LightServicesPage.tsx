...
export const LightServicesPage: React.FC = () => {
              ...
              return (
                <Reveal key={id} delay={(i % 2) * 60}>
                  <button
                    ...
                    className="group flex h-full w-full items-start justify-between gap-6 rounded-xl border border-tas-line bg-tas-surface p-6 text-left shadow-card transition-shadow hover:shadow-card-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tas-primary focus-visible:ring-offset-2"
                  >
                    <span className="min-w-0 flex-1">
                      <span className="block text-xl font-bold text-tas-ink group-hover:text-tas-primary">
                        {title}
                      </span>
                    ...
                    <ArrowRight
                      className="mt-1 h-5 w-5 flex-none text-tas-primary transition-transform group-hover:translate-x-1"
                      aria-hidden="true"
                    />
                  </button>
                </Reveal>
