...
export const LightFaqPage: React.FC = () => {
              ...
              <Reveal key={faq.id} delay={(i % 4) * 40}>
                <div className={i > 0 ? 'border-t border-tas-line' : ''}>
                  <button
                    ...
                    className="flex min-h-16 w-full items-center justify-between gap-6 px-5 py-5 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-tas-primary sm:px-6"
                  >
                    <span className="text-base font-bold text-tas-ink sm:text-lg">{faq.q}</span>
                    <ChevronDown
                      className={`h-5 w-5 flex-shrink-0 text-tas-primary transition-transform duration-300 ${
                        isOpen ? 'rotate-180' : ''
                      }`}
                    />
                  </button>
        ...
        <Reveal>
          <div className="mt-16 flex flex-col items-start justify-between gap-6 rounded-xl bg-tas-primary-soft p-6 sm:p-8 md:flex-row md:items-center md:p-10">
            ...
            <button
              ...
              className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-lg bg-tas-primary px-5 text-sm font-bold text-white transition-colors hover:bg-tas-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tas-primary focus-visible:ring-offset-2 md:w-auto"
            >
