...
const RouteRow: React.FC<{
  ...
  return (
    <a
      ...
      className="group flex w-full items-center justify-between gap-4 rounded-xl border border-tas-line bg-tas-surface p-5 text-left shadow-card transition-shadow hover:shadow-card-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tas-primary focus-visible:ring-offset-2"
    >
      ...
      <span className="flex flex-none items-center gap-3">
        ...
        <ArrowRight
          className="h-5 w-5 flex-none text-tas-primary transition-transform group-hover:translate-x-1"
          aria-hidden="true"
        />
      </span>
    </a>
...
export const LightBookingPage: React.FC = () => {
          ...
          {heroPrefill && (
            <div className="mt-6 flex flex-wrap items-start justify-between gap-3 rounded-xl bg-tas-primary-soft p-4">
              ...
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-full text-tas-muted-text transition-colors hover:bg-tas-surface hover:text-tas-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tas-primary"
              >
          ...
          <Reveal>
            ...
            <div className="flex flex-col gap-6 rounded-xl border border-tas-line bg-tas-surface p-6 shadow-card sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-4">
                <div className="flex h-11 w-11 flex-none items-center justify-center rounded-full bg-tas-primary-soft text-tas-primary">
              ...
              <button
                ...
                className="inline-flex min-h-12 flex-none items-center justify-center gap-2 self-start rounded-lg bg-tas-primary px-5 text-sm font-bold text-white transition-colors hover:bg-tas-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tas-primary focus-visible:ring-offset-2 sm:self-auto"
              >
