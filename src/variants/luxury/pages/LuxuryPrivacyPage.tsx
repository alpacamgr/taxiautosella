    ...
    <div className="min-h-screen bg-[#F8F6F0] pt-24 pb-20">
      <div className="mx-auto max-w-3xl px-6 lg:px-16">
        ...
        <div className="space-y-10 text-[15px] font-light leading-relaxed text-[#0E1117]/85">
          ...
          <section>
            <h2 className="font-editorial text-2xl text-[#0E1117]">{t('privacy.sections.controller.title')}</h2>
            <div className="mt-3 space-y-1">
              ...
              <p className="text-[#0E1117]/60">{t('privacy.sections.controller.dpoNote')}</p>
            </div>
          </section>

          <section>
            <h2 className="font-editorial text-2xl text-[#0E1117]">{t('privacy.sections.data.title')}</h2>
          ...
          <section>
            <h2 className="font-editorial text-2xl text-[#0E1117]">{t('privacy.sections.bases.title')}</h2>
            <ul className="mt-3 list-disc space-y-2 pl-6">
          ...
          <section>
            <h2 className="font-editorial text-2xl text-[#0E1117]">{t('privacy.sections.recipients.title')}</h2>
            ...
            <p className="mt-3 text-[#0E1117]/70">{t('privacy.sections.recipients.note')}</p>
          </section>

          <section>
            <h2 className="font-editorial text-2xl text-[#0E1117]">{t('privacy.sections.transfers.title')}</h2>
            <p className="mt-3">{t('privacy.sections.transfers.body')}</p>
          </section>

          <section>
            <h2 className="font-editorial text-2xl text-[#0E1117]">{t('privacy.sections.retention.title')}</h2>
            <p className="mt-3">{t('privacy.sections.retention.body')}</p>
            <p className="mt-2 text-[#0E1117]/70">{t('privacy.sections.retention.note')}</p>
          </section>

          <section>
            <h2 className="font-editorial text-2xl text-[#0E1117]">{t('privacy.sections.rights.title')}</h2>
          ...
          <section>
            <h2 className="font-editorial text-2xl text-[#0E1117]">{t('privacy.sections.complaint.title')}</h2>
            <p className="mt-3">
              <Trans
          ...
          <section>
            <h2 className="font-editorial text-2xl text-[#0E1117]">{t('privacy.sections.automated.title')}</h2>
            <p className="mt-3">{t('privacy.sections.automated.body')}</p>
          </section>

          <section>
            <h2 className="font-editorial text-2xl text-[#0E1117]">{t('privacy.sections.changes.title')}</h2>
